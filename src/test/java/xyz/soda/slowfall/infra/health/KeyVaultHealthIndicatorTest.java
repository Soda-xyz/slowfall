...
public class KeyVaultHealthIndicatorTest {
    ...
    public void healthReturnsUnknownWhenNoClientsConfigured() {
        ...
        KeyVaultHealthIndicator hi = new KeyVaultHealthIndicator(emptyKeyProvider, emptySecretProvider, "https://kv", "", "");
        Health h = hi.health();
    ...
    public void healthDownWhenKeyMissing() {
        ...
        KeyVaultHealthIndicator hi = new KeyVaultHealthIndicator(keyProvider, emptySecretProvider, "https://kv", "missing-key", "");
        Health h = hi.health();
    ...
    public void healthUpWhenSecretPresent() {
        ...
        KeyVaultHealthIndicator hi = new KeyVaultHealthIndicator(emptyKeyProvider, secretProvider, "https://kv", "", "sname");
        Health h = hi.health();

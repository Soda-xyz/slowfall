...
vi.mock('../jump/JumpForm', () => ({ default: () => <div>JumpForm</div> }));
vi.mock('../jump/JumpTable', () => ({ default: () => <div>JumpTable</div> }));
vi.mock('../jump/JumpPlanner', () => ({ default: () => <div>JumpPlanner</div> }));
vi.mock('../jump/api', () => ({ fetchJumps: vi.fn(() => Promise.resolve([])) }));
vi.mock('../person/api', () => ({ fetchPilots: vi.fn(() => Promise.resolve([])), fetchSkydivers: vi.fn(() => Promise.resolve([])) }));
